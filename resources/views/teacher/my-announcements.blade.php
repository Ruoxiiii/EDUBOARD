                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm hover:shadow-md transition-shadow">
                    <div class="flex items-start justify-between gap-4 mb-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-semibold text-gray-900 dark:text-gray-100">{{ Auth::user()->name }}</h4>
                                <p class="text-xs text-gray-500 dark:text-gray-400">2026-03-15 · Academic</p>
                            </div>
                        </div>
                    </div>
                    <h3 class="text-base font-bold text-gray-900 dark:text-gray-100 mb-2">Midterm Examination Schedule</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">The midterm exams will start next week. Please check your portals for the specific schedule and room assignments.</p>
                </div>
                <div class="absolute top-4 right-4 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button class="p-1.5 rounded-lg bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-400">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-3.5 w-3.5">
