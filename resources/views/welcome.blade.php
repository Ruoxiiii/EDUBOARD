         ...
         <main> 
             ...
             <div class="cards"> 
                 ...
                 <a href="{{ route('login') }}?role=admin" class="card card--admin"> 
                     ...
                     <div class="card-enter">Enter <span class="arrow">→</span></div> 
                 </a> 
  
                 <!-- Teacher --> 
                 <a href="{{ route('login') }}?role=teacher" class="card card--teacher"> 
                     <div class="card-icon"> 
                         <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"> 
             ...
             <div class="footer-note">Demo for Westfield Academy &nbsp;•&nbsp; Select a role to explore</div> 
         </main> 
     </div> 
 </body> 
 </html> 
